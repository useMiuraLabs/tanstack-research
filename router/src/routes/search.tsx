    ...
    <div className="p-8 space-y-6">
      ...
      <section className="rounded-lg border border-amber-300 bg-amber-50 p-4 text-sm">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-amber-900">
          <li>
            URL を直接書き換えて不正値 (例:{' '}
            <code className="rounded bg-amber-100 px-1">?sort=banana</code>) を
            入れても <code>catch</code> がデフォルト値に倒すこと
          </li>
          <li>ブラウザの戻る/進むで search params 状態が完全に復元されること</li>
          <li>
            <code>Route.useSearch()</code> の戻り値の型を hover で確認 (Zod
            schema から推論される)
          </li>
          <li>
          ...
          <li>
            <code>loaderDeps</code> に指定した search params が変わると loader
            が再実行される (cache key に含まれる)
          </li>
        </ul>
      </section>
    </div>
